...
/* package gadt-interpreter-0.1.0.0 */
#ifndef VERSION_gadt_interpreter
#define VERSION_gadt_interpreter "0.1.0.0"
#endif /* VERSION_gadt_interpreter */
#ifndef MIN_VERSION_gadt_interpreter
#define MIN_VERSION_gadt_interpreter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_gadt_interpreter */
...
#define CURRENT_COMPONENT_ID "gadt-interpreter-0.1.0.0-inplace-gadt-interpreter"
